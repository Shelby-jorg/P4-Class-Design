...
std::string ClassDesignB::getFileName() {
	return fileName;
}
std::string ClassDesignB::getImageType() {
...
std::string ClassDesignB::getDateCreated() {
	return dateCreated;
}
double ClassDesignB::getSize() {
	return size;
}
std::string ClassDesignB::getAuthorName() {
	return authorName;
}
int ClassDesignB::getImageDimensions() {
	return imgHeight * imgWidth;
}
int ClassDesignB::getImageHeight() {
	return imgHeight;
}
int ClassDesignB::getImageWidth() {
	return imgWidth;
}
int ClassDesignB::getApertureSize() {
	return apertureSize;
}
int ClassDesignB::getExposureTime() {
	return exposureTime;
}
int ClassDesignB::getISOValue() {
	return isoValue;
}
bool ClassDesignB::getFlashEnabled() {
	return flashEnabled;
}
...
void printImageData(ClassDesignB designB) {
	std::cout << "Image Data of File: " << designB.getFileName() << "\n" <<
